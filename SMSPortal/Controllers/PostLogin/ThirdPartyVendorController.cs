...
{
    public class ThirdPartyVendorController : Controller
    {
        public ThirdPartyVendorManager _vendorManager;
        ...
        public ThirdPartyVendorController()
        {
            _vendorManager = new ThirdPartyVendorManager();
        ...
        public ActionResult Insert_Vendor(VendorViewModel vViewModel)
        {
            try
            {
                ...
                _vendorManager.Insert_Vendor(vViewModel.Vendor, vViewModel.Cookies.User_Id, vViewModel.Cookies.Entity_Id);
        ...
        public JsonResult Get_Vendors(VendorViewModel vViewModel)
        {
            ...
            try
            {
                ...
                {
                    vViewModel.Vendors = _vendorManager.Get_Vendors(ref pager, vViewModel.Cookies.Entity_Id);
                }
        ...
        public JsonResult Get_Product_By_Brand(int CurrentPage, int vendor_Id)
        {
            ...
            try
            {
                vViewModel.Cookies = Utility.Get_Login_User("UserInfo", "Token");
                vViewModel.Brands = _vendorManager.Get_Brands();
                vViewModel.Products = _vendorManager.Get_Productmapping(vendor_Id, vViewModel.Cookies.Entity_Id);             
        ...
        public ActionResult Insert_Bank_Details(VendorViewModel vViewModel)
        {
            ...
            return RedirectToAction("Profile", "ThirdPartyVendor");
        }
